      ...
      <form onSubmit={submit} className="space-y-2 mb-5">
        <div className="grid grid-cols-3 gap-2">
          <input
            ...
            maxLength={20}
            type="text"
            className="col-span-1 rounded-md border border-input bg-background focus:outline-none focus:ring-2 focus:ring-primary/30 px-[8px] py-[6px] text-[11px] font-normal text-primary placeholder:text-primary/55"
          />
          <input
            value={content}
            ...
            maxLength={200}
            type="text"
            className="col-span-2 py-2 rounded-md border border-input bg-background focus:outline-none focus:ring-2 focus:ring-primary/30 px-[8px] text-[11px] font-normal text-center text-primary placeholder:text-primary/55"
          />
        </div>
        <button
          type="submit"
